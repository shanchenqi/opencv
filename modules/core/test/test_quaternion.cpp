...
TEST_F(QuatTest, EulerAngles){
    ...
    Quatd qEuler1 = Quatd::createFromEulerAngles(test_angle,INT_XYZ);
    Quatd qEuler2 = Quatd::createFromEulerAngles(test_angle,INT_XZY);
    Quatd qEuler3 = Quatd::createFromEulerAngles(test_angle,INT_XZX);
    Quatd qEuler4 = Quatd::createFromEulerAngles(test_angle,INT_YXZ);
    Quatd qEuler5 = Quatd::createFromEulerAngles(test_angle,INT_YZX);
    ...
    Vec3d Euler_Angles_1 = qEuler1.toEulerAngles(INT_XYZ);
    Vec3d Euler_Angles_2 = qEuler2.toEulerAngles(INT_XZY);
    Vec3d Euler_Angles_3 = qEuler3.toEulerAngles(INT_XZX);
    Vec3d Euler_Angles_4 = qEuler4.toEulerAngles(INT_YXZ);
    Vec3d Euler_Angles_5 = qEuler5.toEulerAngles(INT_YZX);
    ...
    Vec3d Euler_Angles_solute_1 = qEulerLock1.toEulerAngles(INT_XYZ);
